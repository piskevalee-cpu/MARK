...
- **Theme System**: Introduced `/theme` command with 8 premium styles (hl3, matrix, cyberpunk, etc.). Make MARK unique!
- **Dynamic Splashes**: improved startup experience with random splash messages!
...
| `/theme <name>`      | **Change UI Theme** (hl3, matrix, etc.)    |
